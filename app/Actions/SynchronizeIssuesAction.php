...
use App\Commands\SynchronizeIssuesCommand;
...
class SynchronizeIssuesAction extends Action
{
    ...
    public function __invoke(RunCommand $command, CliMenu $menu): void
    {
        ...
        try {
            $command->call(SynchronizeIssuesCommand::class, [
        ...
        } /** @noinspection PhpRedundantCatchClauseInspection */ catch (RequestException $exception) {
