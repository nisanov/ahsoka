...
class SynchronizeIssuesCommand extends Ahsoka
{
     ...
     * @var string
     */
    protected $signature = 'synchronize:issues {--developer= : The developer record identifier} {--year= : The financial year to synchronize}';
