...
class GenerateGraphsCommand extends Ahsoka
{
     ...
     * @var string
     */
    protected $signature = 'generate:graphs {--developer= : The developer record identifier} {--year= : The financial year to generate} {--graph= : The graph type to generate}';
